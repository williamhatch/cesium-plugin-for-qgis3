    ...
    (function () {
        ...
        app.measure = {
            ...
            showResult: function () {
                ...
                html += "<tr><td>Total distance 11:</td><td>" + this.formatLength(total) + " m</td><td></td></tr>";
                ...
                gui.popup.show(html, "Measure distance ppp");
            }
        };
    })();
})();
...
Q3D.Utils.flatArrayToVec2Array = function (vertices, itemSize) {
    ...
    for (var i = 0, l = vertices.length; i < l; i += itemSize) {
        ...
        console.log("point ..." + vertices[i] + "," + vertices[i + 1])
    }
    return pts;
};
